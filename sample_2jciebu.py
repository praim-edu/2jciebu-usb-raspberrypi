import serial
import time
from sample import OmronSample
from datetime import datetime
from databoom import Databoom
import sys
from config import *
...
if __name__ == '__main__':
    ...
    try:
        ...
        db = Databoom(USERID,APITOKEN,CLIENTID)
        while ser.isOpen():
            ...
            s = OmronSample(DEVICEID)
            s.update(data)
            db.client.publish("office/"+DEVICEID+"/environment",s.databoom_message())
